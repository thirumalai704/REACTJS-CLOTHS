...
function OutOfStock() {
  ...
  const outofstockProducts = state?.outofstock || []

  return (
    <div className="p-4">
       <UploadProduct/>
      <h1 className="text-2xl font-bold mb-4 text-red-600">Out of Stock Products</h1>

      {outofstockProducts.length === 0 ? (
        <p className="text-gray-500">No out of stock products available.</p>
      ) : (
